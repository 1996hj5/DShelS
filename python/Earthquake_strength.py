...
df_earthquake.plot.bar(rot=45, color='#f33535', edgecolor='#33425b', linewidth='3')
pyplot.grid()
pyplot.legend(loc='upper left')
pyplot.title('2012-2019년 규모별 지진발생횟수')
pyplot.xlabel('리히터규모')
...
pyplot.savefig('picture/Earthquake_strength/규모별 지진발생횟수_막대그래프.png')
pyplot.show()

# csv파일로 추출
df_earthquake.to_csv('data_after/규모별 지진발생횟수.csv')

# json파일로 추출
df_earthquake.to_json('data_after/earthquake_strength.json', orient='table')